...
use App\SenaraiKlinik;
use App\Tuntutan;
use App\Entiti;
use App\Mail\TuntutanBaru;

class SenaraiklinikController extends Controller
{
    public function __construct()
    {
        // Tetapan lokasi folder resources/views/admin/senaraiklinik
        $this->theme = 'pengguna.senaraiklinik';
    }
