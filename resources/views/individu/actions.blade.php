...
<a href="{{ route('individu.edit', $individu->id)}}" class="btn btn-sm btn-info">KEMASKINI</a>

@if($individu->statusid == 23)
            ...
            <div class="modal-dialog" role="document">
                ...
                <form method="POST" action="{{ route('individu.destroy', $individu->id) }}">
                @csrf
                @method('DELETE')
